...
public class FinalResults extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView player1NameView =  findViewById(R.id.p1name);
        TextView player2NameView =  findViewById(R.id.p2name);
        TextView player1WinsView =  findViewById(R.id.p1wins);
        TextView player2WinsView =  findViewById(R.id.p2wins);
        TextView drawsView =  findViewById(R.id.draws);
